package com.residencia.atividadeAPI.security;
...
import com.residencia.atividadeAPI.security.services.UserDetailsServiceImpl;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    //.requestMatchers().hasAnyRole("USER", "MODERATOR") //autoriza o acesso a rotas por perfis
